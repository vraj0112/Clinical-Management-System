...
public class ContactUs extends JFrame implements ActionListener{
    ...
    ContactUs()
    {
        ...
        l10=new JLabel("19ce128@charusat.edu.in");
        ...
        l12=new JLabel("19ce134@charusat.edu.in");
        ...
        l14=new JLabel("19ce137@charusat.edu.in");
        ...
        l16=new JLabel("19ce138@charusat.edu.in");
